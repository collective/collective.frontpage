...
from collective.frontpage.content.frontpage import IFrontpage
...
class FrontpageIntegrationTest(unittest.TestCase):
    ...
    def test_ct_frontpage_factory(self):
        ...
        self.assertTrue(
            IFrontpage.providedBy(obj), u"IFrontpage not provided by {0}!".format(obj)
        )
    ...
    def test_ct_frontpage_adding(self):
        ...
        self.assertTrue(
            ...
            u"IFrontpage not provided by {0}!".format(obj.id),
        )
    ...
    def test_ct_frontpage_filter_content_type_true(self):
        ...
        parent_id = portal_types.constructContent(
            fti.id, self.portal, "frontpage_id", title="Frontpage container"
        )
